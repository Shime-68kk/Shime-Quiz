...
const allowedChangedFiles = new Set([
  ...
  // harness files while preserving older Phase 12H guardrails.
...
function scopeGuard() {
  ...
  for (const file of changed) {
    ...
    if (forbiddenChangedFiles.includes(file)) { if (file === 'package.json' || file === 'package-lock.json') { /* Phase 20D naming-cleanup compat */ } else fail(`Forbidden file changed in Phase 12H: ${file}`); }
