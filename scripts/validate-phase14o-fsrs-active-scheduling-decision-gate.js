...
phase14oAllowedChangedFiles.add(`docs/research/phase23e-data-survival-comprehension-evidence-run-plan.md`);
phase14oAllowedChangedFiles.add(`docs/release/phase23e-data-survival-comprehension-plan-summary.md`);
phase14oAllowedChangedFiles.add(`scripts/validate-phase23e-data-survival-comprehension-plan.js`);
phase14oAllowedChangedFiles.add(`docs/release/phase23f-phase23-decision-gate.md`);
phase14oAllowedChangedFiles.add(`docs/research/phase23f-data-survival-decision-matrix.md`);
phase14oAllowedChangedFiles.add(`scripts/validate-phase23f-phase23-decision-gate.js`);
...
phase14oAllowedChangedFiles.add(`docs/research/phase24d-backup-export-restore-adapter-awareness-design.md`);
phase14oAllowedChangedFiles.add(`docs/release/phase24d-backup-export-restore-adapter-awareness-summary.md`);
phase14oAllowedChangedFiles.add(`scripts/validate-phase24d-backup-export-restore-adapter-awareness-design.js`);
...
phase14oAllowedChangedFiles.add(`docs/research/phase23c-backup-health-last-backup-indicator-design.md`);
phase14oAllowedChangedFiles.add(`docs/release/phase23c-backup-health-design-summary.md`);
phase14oAllowedChangedFiles.add(`scripts/validate-phase23c-backup-health-design.js`);
phase14oAllowedChangedFiles.add(`docs/research/phase23d-backup-reminder-risk-friction-design.md`);
phase14oAllowedChangedFiles.add(`docs/release/phase23d-backup-reminder-risk-friction-summary.md`);
phase14oAllowedChangedFiles.add(`scripts/validate-phase23d-backup-reminder-risk-friction-design.js`);
phase14oAllowedChangedFiles.add(`docs/research/phase24d-hf1-validator-forward-compat-maintenance.md`);
phase14oAllowedChangedFiles.add(`docs/release/phase24d-hf1-validator-forward-compat-summary.md`);
phase14oAllowedChangedFiles.add(`scripts/register-phase-forward-compat.js`);
phase14oAllowedChangedFiles.add(`scripts/validate-phase24d-hf1-validator-forward-compat-maintenance.js`);
...
function noNewSrcFilesGuard() {
  ...
  'src/state/v2BackupRestore.js',
  // Phase 17B exact src files (forward compatibility — StorageAdapter Scaffold)
  'src/storage/StorageAdapter.js',
  'src/storage/LocalStorageAdapter.js',
  'src/storage/storageAdapterRegistry.js',
  'src/state/recommendationFeedbackStorage.js',
  ...
  `scripts/validate-phase22f-actual-stress-run.js`,].includes(file)) continue;
    ...
    if (file === 'src/version.js') { /* Phase 20D naming-cleanup compat */ } else fail(`Unexpected src/ file changed in Phase 14O scope: ${file}`);
  }
}
