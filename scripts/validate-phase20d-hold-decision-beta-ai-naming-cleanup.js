...
phase20dAllowedChangedFiles.add(`docs/release/phase23f-phase23-decision-gate.md`);
phase20dAllowedChangedFiles.add(`docs/research/phase23f-data-survival-decision-matrix.md`);
phase20dAllowedChangedFiles.add(`scripts/validate-phase23f-phase23-decision-gate.js`);
phase20dAllowedChangedFiles.add(`docs/research/phase24a-residual-direct-storage-audit.md`);
phase20dAllowedChangedFiles.add(`docs/release/phase24a-residual-direct-storage-audit-summary.md`);
phase20dAllowedChangedFiles.add(`scripts/validate-phase24a-residual-direct-storage-audit.js`);
...
phase20dAllowedChangedFiles.add(`docs/research/phase24d-backup-export-restore-adapter-awareness-design.md`);
phase20dAllowedChangedFiles.add(`docs/release/phase24d-backup-export-restore-adapter-awareness-summary.md`);
phase20dAllowedChangedFiles.add(`scripts/validate-phase24d-backup-export-restore-adapter-awareness-design.js`);
...
phase20dAllowedChangedFiles.add(`docs/research/phase24d-hf1-validator-forward-compat-maintenance.md`);
phase20dAllowedChangedFiles.add(`docs/release/phase24d-hf1-validator-forward-compat-summary.md`);
phase20dAllowedChangedFiles.add(`scripts/register-phase-forward-compat.js`);
phase20dAllowedChangedFiles.add(`scripts/validate-phase24d-hf1-validator-forward-compat-maintenance.js`);
