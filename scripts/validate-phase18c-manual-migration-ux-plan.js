...
phase18cAllowedChangedFiles.add(`docs/research/phase23e-data-survival-comprehension-evidence-run-plan.md`);
phase18cAllowedChangedFiles.add(`docs/release/phase23e-data-survival-comprehension-plan-summary.md`);
phase18cAllowedChangedFiles.add(`scripts/validate-phase23e-data-survival-comprehension-plan.js`);
...
phase18cAllowedChangedFiles.add(`docs/research/phase24b-storage-adapter-coverage-boundary-decision.md`);
phase18cAllowedChangedFiles.add(`docs/release/phase24b-storage-adapter-boundary-summary.md`);
phase18cAllowedChangedFiles.add(`scripts/validate-phase24b-storage-adapter-boundary-decision.js`);
// Phase 24C forward-compat entries (Help Tour StorageAdapter scaffold)
phase18cAllowedChangedFiles.add(`src/ui/helpTourStorage.js`);
phase18cAllowedChangedFiles.add(`src/ui/helpTour.js`);
phase18cAllowedChangedFiles.add(`tests/unit/helpTourStorageAdapterScaffold.test.js`);
...
phase18cAllowedChangedFiles.add(`docs/research/phase24d-hf1-validator-forward-compat-maintenance.md`);
phase18cAllowedChangedFiles.add(`docs/release/phase24d-hf1-validator-forward-compat-summary.md`);
phase18cAllowedChangedFiles.add(`scripts/register-phase-forward-compat.js`);
phase18cAllowedChangedFiles.add(`scripts/validate-phase24d-hf1-validator-forward-compat-maintenance.js`);
...
function packageGuard() {
  ...
  if (!allowed.has(pkgVer)) fail('package.json version unexpected in Phase 18C: ' + pkgVer);
  if (!allowed.has(lockVer)) fail('package-lock.json version unexpected in Phase 18C: ' + lockVer);
}
