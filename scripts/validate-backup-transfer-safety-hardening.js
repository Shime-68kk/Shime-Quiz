...
function assertNoUnsupportedPositiveClaims(file) {
  ...
  const safeNegation = /\b(no|not|does not|do not|without|unless|was not|were not|is not|isn't|doesn't|future|plan|planned|requirements|documented|forbidden claims|do not claim)\b/i;
