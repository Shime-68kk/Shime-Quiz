...
hf1AllowedChangedFiles.add(`docs/research/phase23e-data-survival-comprehension-evidence-run-plan.md`);
hf1AllowedChangedFiles.add(`docs/release/phase23e-data-survival-comprehension-plan-summary.md`);
hf1AllowedChangedFiles.add(`scripts/validate-phase23e-data-survival-comprehension-plan.js`);
hf1AllowedChangedFiles.add(`docs/release/phase23f-phase23-decision-gate.md`);
hf1AllowedChangedFiles.add(`docs/research/phase23f-data-survival-decision-matrix.md`);
hf1AllowedChangedFiles.add(`scripts/validate-phase23f-phase23-decision-gate.js`);
hf1AllowedChangedFiles.add(`docs/research/phase24a-residual-direct-storage-audit.md`);
hf1AllowedChangedFiles.add(`docs/release/phase24a-residual-direct-storage-audit-summary.md`);
hf1AllowedChangedFiles.add(`scripts/validate-phase24a-residual-direct-storage-audit.js`);
hf1AllowedChangedFiles.add(`docs/research/phase24b-storage-adapter-coverage-boundary-decision.md`);
hf1AllowedChangedFiles.add(`docs/release/phase24b-storage-adapter-boundary-summary.md`);
hf1AllowedChangedFiles.add(`scripts/validate-phase24b-storage-adapter-boundary-decision.js`);
// Phase 24C forward-compat entries (Help Tour StorageAdapter scaffold)
hf1AllowedChangedFiles.add(`src/ui/helpTourStorage.js`);
hf1AllowedChangedFiles.add(`src/ui/helpTour.js`);
hf1AllowedChangedFiles.add(`tests/unit/helpTourStorageAdapterScaffold.test.js`);
hf1AllowedChangedFiles.add(`docs/research/phase24c-help-tour-storage-adapter-scaffold.md`);
hf1AllowedChangedFiles.add(`docs/release/phase24c-help-tour-storage-adapter-scaffold-summary.md`);
hf1AllowedChangedFiles.add(`scripts/validate-phase24c-help-tour-storage-adapter-scaffold.js`);
// Phase 24D forward-compat entries (Backup/Export/Restore Adapter-Awareness Design)
hf1AllowedChangedFiles.add(`docs/research/phase24d-backup-export-restore-adapter-awareness-design.md`);
hf1AllowedChangedFiles.add(`docs/release/phase24d-backup-export-restore-adapter-awareness-summary.md`);
hf1AllowedChangedFiles.add(`scripts/validate-phase24d-backup-export-restore-adapter-awareness-design.js`);
