...
phase17eAllowedChangedFiles.add(`docs/research/phase23e-data-survival-comprehension-evidence-run-plan.md`);
phase17eAllowedChangedFiles.add(`docs/release/phase23e-data-survival-comprehension-plan-summary.md`);
phase17eAllowedChangedFiles.add(`scripts/validate-phase23e-data-survival-comprehension-plan.js`);
phase17eAllowedChangedFiles.add(`docs/release/phase23f-phase23-decision-gate.md`);
phase17eAllowedChangedFiles.add(`docs/research/phase23f-data-survival-decision-matrix.md`);
phase17eAllowedChangedFiles.add(`scripts/validate-phase23f-phase23-decision-gate.js`);
...
phase17eAllowedChangedFiles.add(`docs/research/phase24d-backup-export-restore-adapter-awareness-design.md`);
phase17eAllowedChangedFiles.add(`docs/release/phase24d-backup-export-restore-adapter-awareness-summary.md`);
phase17eAllowedChangedFiles.add(`scripts/validate-phase24d-backup-export-restore-adapter-awareness-design.js`);
...
phase17eAllowedChangedFiles.add(`docs/research/phase23c-backup-health-last-backup-indicator-design.md`);
phase17eAllowedChangedFiles.add(`docs/release/phase23c-backup-health-design-summary.md`);
phase17eAllowedChangedFiles.add(`scripts/validate-phase23c-backup-health-design.js`);
phase17eAllowedChangedFiles.add(`docs/research/phase23d-backup-reminder-risk-friction-design.md`);
phase17eAllowedChangedFiles.add(`docs/release/phase23d-backup-reminder-risk-friction-summary.md`);
phase17eAllowedChangedFiles.add(`scripts/validate-phase23d-backup-reminder-risk-friction-design.js`);
phase17eAllowedChangedFiles.add(`docs/research/phase24d-hf1-validator-forward-compat-maintenance.md`);
phase17eAllowedChangedFiles.add(`docs/release/phase24d-hf1-validator-forward-compat-summary.md`);
phase17eAllowedChangedFiles.add(`scripts/register-phase-forward-compat.js`);
phase17eAllowedChangedFiles.add(`scripts/validate-phase24d-hf1-validator-forward-compat-maintenance.js`);
