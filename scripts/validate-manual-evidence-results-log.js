...
if (pkg.version !== '2.0.0-beta.1') {
  fail(`package.json version changed: expected 2.0.0-beta.1, got ${pkg.version}`);
}
if (lock.version !== '2.0.0-beta.1') {
  fail(`package-lock.json version changed: expected 2.0.0-beta.1, got ${lock.version}`);
}
const expectedDeps = {
  dependencies: {
