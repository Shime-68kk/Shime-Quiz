...
phase14jAllowedChangedFiles.add(`docs/research/phase23e-data-survival-comprehension-evidence-run-plan.md`);
phase14jAllowedChangedFiles.add(`docs/release/phase23e-data-survival-comprehension-plan-summary.md`);
phase14jAllowedChangedFiles.add(`scripts/validate-phase23e-data-survival-comprehension-plan.js`);
phase14jAllowedChangedFiles.add(`docs/release/phase23f-phase23-decision-gate.md`);
phase14jAllowedChangedFiles.add(`docs/research/phase23f-data-survival-decision-matrix.md`);
phase14jAllowedChangedFiles.add(`scripts/validate-phase23f-phase23-decision-gate.js`);
phase14jAllowedChangedFiles.add(`docs/research/phase24a-residual-direct-storage-audit.md`);
phase14jAllowedChangedFiles.add(`docs/release/phase24a-residual-direct-storage-audit-summary.md`);
phase14jAllowedChangedFiles.add(`scripts/validate-phase24a-residual-direct-storage-audit.js`);
phase14jAllowedChangedFiles.add(`docs/research/phase24b-storage-adapter-coverage-boundary-decision.md`);
phase14jAllowedChangedFiles.add(`docs/release/phase24b-storage-adapter-boundary-summary.md`);
phase14jAllowedChangedFiles.add(`scripts/validate-phase24b-storage-adapter-boundary-decision.js`);
// Phase 24C forward-compat entries (Help Tour StorageAdapter scaffold)
phase14jAllowedChangedFiles.add(`src/ui/helpTourStorage.js`);
phase14jAllowedChangedFiles.add(`src/ui/helpTour.js`);
phase14jAllowedChangedFiles.add(`tests/unit/helpTourStorageAdapterScaffold.test.js`);
phase14jAllowedChangedFiles.add(`docs/research/phase24c-help-tour-storage-adapter-scaffold.md`);
phase14jAllowedChangedFiles.add(`docs/release/phase24c-help-tour-storage-adapter-scaffold-summary.md`);
phase14jAllowedChangedFiles.add(`scripts/validate-phase24c-help-tour-storage-adapter-scaffold.js`);
// Phase 24D forward-compat entries (Backup/Export/Restore Adapter-Awareness Design)
phase14jAllowedChangedFiles.add(`docs/research/phase24d-backup-export-restore-adapter-awareness-design.md`);
phase14jAllowedChangedFiles.add(`docs/release/phase24d-backup-export-restore-adapter-awareness-summary.md`);
phase14jAllowedChangedFiles.add(`scripts/validate-phase24d-backup-export-restore-adapter-awareness-design.js`);
phase14jAllowedChangedFiles.add(`docs/research/phase23b-data-survival-ux-copy-decision.md`);
phase14jAllowedChangedFiles.add(`docs/release/phase23b-data-survival-ux-copy-summary.md`);
phase14jAllowedChangedFiles.add(`scripts/validate-phase23b-data-survival-ux-copy.js`);
phase14jAllowedChangedFiles.add(`docs/research/phase23c-backup-health-last-backup-indicator-design.md`);
phase14jAllowedChangedFiles.add(`docs/release/phase23c-backup-health-design-summary.md`);
phase14jAllowedChangedFiles.add(`scripts/validate-phase23c-backup-health-design.js`);
phase14jAllowedChangedFiles.add(`docs/research/phase23d-backup-reminder-risk-friction-design.md`);
phase14jAllowedChangedFiles.add(`docs/release/phase23d-backup-reminder-risk-friction-summary.md`);
phase14jAllowedChangedFiles.add(`scripts/validate-phase23d-backup-reminder-risk-friction-design.js`);
phase14jAllowedChangedFiles.add(`docs/research/phase24d-hf1-validator-forward-compat-maintenance.md`);
phase14jAllowedChangedFiles.add(`docs/release/phase24d-hf1-validator-forward-compat-summary.md`);
phase14jAllowedChangedFiles.add(`scripts/register-phase-forward-compat.js`);
phase14jAllowedChangedFiles.add(`scripts/validate-phase24d-hf1-validator-forward-compat-maintenance.js`);
