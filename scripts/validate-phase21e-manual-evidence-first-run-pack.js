...
phase21ePaths.push(`docs/research/phase23c-backup-health-last-backup-indicator-design.md`);
phase21ePaths.push(`docs/release/phase23c-backup-health-design-summary.md`);
phase21ePaths.push(`scripts/validate-phase23c-backup-health-design.js`);
phase21ePaths.push(`docs/research/phase23d-backup-reminder-risk-friction-design.md`);
phase21ePaths.push(`docs/release/phase23d-backup-reminder-risk-friction-summary.md`);
phase21ePaths.push(`scripts/validate-phase23d-backup-reminder-risk-friction-design.js`);
...
function validateHistoricalForwardCompat() {
  ...
  for (const file of changedValidators) {
    ...
    for (const line of diff.split(/\r?\n/)) {
      ...
      if (line.includes(`isPhase24b`)) continue;
      if (line.includes(`isPhase24c`)) continue;
      if (![...phase21ePaths, ...phase23eForwardCompatPaths, ...phase23fForwardCompatPaths, ...phase24aForwardCompatPaths, ...phase24bForwardCompatPaths, ...phase24cForwardCompatPaths, ...phase24dForwardCompatPaths, ...phase24dHf1ForwardCompatPaths].some(path => line.includes(path))) {
        fail(`${file} has non-Phase-21E forward-compat addition: ${line}`);
      }
      for (const path of [...phase21ePaths, ...phase23eForwardCompatPaths, ...phase23fForwardCompatPaths, ...phase24aForwardCompatPaths, ...phase24bForwardCompatPaths, ...phase24cForwardCompatPaths, ...phase24dForwardCompatPaths, ...phase24dHf1ForwardCompatPaths]) {
