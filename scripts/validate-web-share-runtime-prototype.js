...
function assertNoForbiddenPositiveClaims(file) {
  ...
  const safeNegation = /\b(no|not|does not|do not|without|unless|was not|were not|is not|isn't|doesn't|future|planned|candidate|fallback|forbidden claims|do not claim)\b|không/i;
